...
assert Path(octomap_bt_file).exists(), 'File not found: %s' % octomap_bt_file
octomap_free_space_min_hdf5_file = os.path.join(args.octomap_dir, "octomap_free_space_min.hdf5")
assert Path(octomap_free_space_min_hdf5_file).exists(), 'File not found: %s' % octomap_free_space_min_hdf5_file
octomap_free_space_max_hdf5_file = os.path.join(args.octomap_dir, "octomap_free_space_max.hdf5")
assert Path(octomap_free_space_max_hdf5_file).exists(), 'File not found: %s' % octomap_free_space_max_hdf5_file
